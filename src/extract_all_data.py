...
lst_fed = [pd.read_csv(fil, parse_dates=True, index_col=0) for fil in fil_fed]
...
df_zil.columns = cn.COL_HSE_DATA[3:]

# --Final Data--
# Merge data using indexes
df_house_data = df_fed.merge(df_zil, left_index=True, right_index=True)

# Change column names
df_house_data.columns = cn.COL_HSE_DATA
